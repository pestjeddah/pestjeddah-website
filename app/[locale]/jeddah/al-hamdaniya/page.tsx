...
export async function generateMetadata({
  ...
  return {
    title: isArabic 
      ...
      : 'Pest Control in Al-Hamdaniya Jeddah | Professional Service — Al-Ustora',
    description: isArabic
      ? 'خدمة مكافحة حشرات متخصصة في حي الحمدانية بجدة. فريق خبير، تقنيات حديثة، ضمان شامل. اتصل الآن.'
      : 'Specialized pest control service in Al-Hamdaniya district, Jeddah. Expert team, modern techniques, comprehensive guarantee. Call now.',
  };
}

export default function AlHamdaniyaPage({ params: { locale } }: Props) {
  const isArabic = locale === 'ar';
  ...
  const whatsappMessage = isArabic 
    ...
    : 'Hello, I want pest control service in Al-Hamdaniya area';
      ...
      <div className="bg-gray-50 py-4">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-900">{isArabic ? 'الحمدانية' : 'Al-Hamdaniya'}</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 text-primary mb-4">
                <MapPin size={20} />
                <span className="font-semibold">{isArabic ? 'حي الحمدانية، جدة' : 'Al-Hamdaniya, Jeddah'}</span>
              </div>
              
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                {isArabic ? 'مكافحة الحشرات في الحمدانية' : 'Pest Control in Al-Hamdaniya'}
              </h1>
              
              <p className="text-xl text-gray-600 mb-8">
                {isArabic 
                  ? 'خدمة احترافية لمكافحة جميع أنواع الحشرات في حي الحمدانية. فريق خبير متاح 24/7 لخدمتك.'
                  : 'Professional service for all types of pest control in Al-Hamdaniya area. Expert team available 24/7 to serve you.'
                }
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              {isArabic ? 'خدماتنا في الحمدانية' : 'Our Services in Al-Hamdaniya'}
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                {isArabic ? 'لماذا تختارنا في الحمدانية؟' : 'Why Choose Us in Al-Hamdaniya?'}
              </h2>
              ...
              <div className="space-y-4">
                {(isArabic ? [
                ...
                ] : [
                  {
                    ...
                    desc: 'We know Al-Hamdaniya challenges and provide customized solutions'
                  },
                  {
            ...
            <div>
              ...
              <div className="p-6 bg-primary/5 rounded-xl border border-primary/20">
                <h3 className="text-xl font-bold text-gray-900 mb-4">
                  {isArabic ? 'تغطية شاملة في الحمدانية:' : 'Complete Coverage in Al-Hamdaniya:'}
                </h3>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            {isArabic ? 'جاهزون لخدمتك في الحمدانية' : 'Ready to Serve You in Al-Hamdaniya'}
          </h2>
          <p className="text-xl mb-8 opacity-90">
            {isArabic 
              ? 'احصل على استشارة مجانية وخصم خاص لسكان الحمدانية'
              : 'Get free consultation and special discount for Al-Hamdaniya residents'
            }
          </p>
