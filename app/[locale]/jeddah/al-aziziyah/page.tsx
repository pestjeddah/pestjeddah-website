  ...
  return (
    <>
      ...
      <SchemaInjector 
        type="service" 
        data={{
          title: isArabic ? 'مكافحة الحشرات في العزيزية' : 'Pest Control in Al-Aziziyah',
          description: isArabic 
            ? 'خدمة مكافحة حشرات متخصصة للمجمعات السكنية في حي العزيزية بجدة'
            : 'Specialized residential complex pest control service in Al-Aziziyah district, Jeddah',
